...
/***/ function(module, exports, __webpack_require__) {
	...
	var Elemental = __webpack_require__(3);
...
/***/ function(module, exports) {
	...
	(function (Elemental) {
	    var Element = (function () {
	        ...
	        Element.prototype.makeDiv = function () {
	            var div = document.createElement('div');
	            div.className = "element " + this.group;
	            div.appendChild(createClassDiv("number", this.num.toString()));
	            div.appendChild(createClassDiv("abbr", this.abbr));
	            div.appendChild(createClassDiv("name", this.name));
	            return div;
	        };
	        Element.prototype.makeIconDiv = function () {
	            var div = document.createElement('div');
	            div.className = "elementIcon " + this.group;
	            div.appendChild(createClassDiv("abbr", this.abbr));
	            return div;
	        };
	        return Element;
	    ...
	    var inputString = document.getElementById("periodic-input-string");
	    var searchButton = document.getElementById("periodic-search-button");
	    var max = 0;
	    var Failure = -1;
	    searchButton.onclick = function (e) {
	        ...
	        var solutions = matchSentence(inputString.value);
	        ...
	        if (solutions.length > 0) {
	            solutions.forEach(function (solution) {
	                ...
	                solution.forEach(function (element) {
	                    ...
	                    solutionDiv.appendChild(element.makeIconDiv());
	                });
	                //Periodic.ResultsBox.appendChild(document.createElement('br'));
	                resultsBox.appendChild(solutionDiv);
	                //resultsBox.add
	            });
	        }
	        else {
	            resultsBox.innerHTML = "No possible element combination found.";
	            var arr = _.range(5).map(function (n) {
	                return n * 4;
	            });
	            arr.forEach(function (n) {
	                resultsBox.innerHTML += "<br/>Foo " + n.toString();
	            });
	        }
	    };
	    ...
	    function createSolutionDiv() {
	        ...
	        header.innerText += "Solution";
	        //header.appendData("Solution");
	    ...
	    function makeTable(data) {
	        ...
	        for (var k in data) {
	            ...
	            table[k.toLowerCase()] = new Element(k, data[k]);
	        }
	        return table;
	    }
	    function matchSentence(sentence) {
	        return matchWordRec([], sentence.replace(/[^a-zA-Z ]/g, "").toLowerCase());
	    }
	    Elemental.matchSentence = matchSentence;
	    function matchWordRec(elements, input) {
	        var word = input.trim();
	        if (word != undefined && word.length > 0) {
	            ...
	            var solutions = [];
	            for (var i = 1; (i <= max && i <= word.length); i++) {
	                var curmatch = table[word.substring(0, i)];
	                ...
	                if (curmatch != undefined) {
	                    ...
	                    matchWordRec(elements.concat(curmatch), word.substring(i, word.length)).forEach(function (solution) {
	...
	})(Elemental = exports.Elemental || (exports.Elemental = {}));
